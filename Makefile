...
runtime/runtime.a: runtime/main.o runtime/ppu.o runtime/nametable.o
	...
	clang -shared -g -o runtime/runtime.so runtime/main.o runtime/ppu.o runtime/nametable.o

runtime/main.o: runtime/main.c
	clang -fPIC -g -o runtime/main.o -c runtime/main.c

runtime/ppu.o: runtime/ppu.c
	clang -fPIC -g -o runtime/ppu.o -c runtime/ppu.c

runtime/nametable.o: runtime/nametable.c
	clang -fPIC -g -o runtime/nametable.o -c runtime/nametable.c
